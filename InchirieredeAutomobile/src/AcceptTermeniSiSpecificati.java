 ...
 */
public class AcceptTermeniSiSpecificati extends javax.swing.JFrame {

    /**
     * Creates new form TermeSiSpecificati
     */
    public AcceptTermeniSiSpecificati() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        inainte = new javax.swing.JButton();
        ...
        jLabel2.setText("Selectați dacă sunteți de acord!");

        inainte.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        inainte.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagini/Enter_20px.png"))); // NOI18N
        inainte.setText("Inainte");
        inainte.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                inainteActionPerformed(evt);
            }
        });
    ...
    private void inainteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_inainteActionPerformed
        // TODO add your handling code here:
        if(select.isSelected()){
            InchiriereAutomobil obj=new InchiriereAutomobil();
             obj.setVisible(true);
            dispose(); 
        }else{
            JOptionPane.showMessageDialog(null,"Pentru a continua trebuie sa selectați căsuța!");
        }       
    }//GEN-LAST:event_inainteActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AcceptTermeniSiSpecificati.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AcceptTermeniSiSpecificati().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton inainte;
